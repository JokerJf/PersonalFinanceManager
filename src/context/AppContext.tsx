...
interface AppContextType {
  ...
  changeLanguage: (lang: "ru" | "uz" | "en") => void;
...
export const AppProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [language, setLanguageState] = useState<"ru" | "uz" | "en">(
    (i18n.resolvedLanguage as "ru" | "uz" | "en") || "ru"
  );
  ...
  useEffect(() => {
    const currentLang = (i18n.resolvedLanguage as "ru" | "uz" | "en") || "ru";
  ...
  const changeLanguage = useCallback((lang: "ru" | "uz" | "en") => {
