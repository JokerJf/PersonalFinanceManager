    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="rounded-3xl border border-border/30 p-5 card-container">
        ...
        <div className="flex justify-center gap-6 mt-3">
          <div className="flex items-center gap-1.5 text-xs font-medium"><div className="w-2.5 h-2.5 rounded-full bg-success" />Income</div>
          <div className="flex items-center gap-1.5 text-xs font-medium"><div className="w-2.5 h-2.5 rounded-full bg-destructive" />Expenses</div>
        </div>
      </div>
